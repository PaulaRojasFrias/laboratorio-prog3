...
from comisiones.views import cstf_create, cstf_delete, cstf_detalle, cstf_edit, cstf_lista, cstf_misComisiones,integranteComision_create, integranteComision_delete, integranteComision_detalle, integranteComision_edit, integranteTE_create, integranteTE_delete, integranteTE_edit, te_create, te_delete, te_detalle, te_edit, te_lista, te_misTribunales
...
urlpatterns = [
    ...
    path('comision/miscomisiones/<int:cuilDocente>', cstf_misComisiones, name='cstf_misComisiones'),

    path('comision/mistribunales/<int:cuilDocente>', te_misTribunales, name='te_misTribunales'),
